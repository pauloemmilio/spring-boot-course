...
public class EmpresaServiceTest {
	...
	@MockBean // cria um objeto falsa, ao invés de injetar um objeto via Autowired 
	...
	public void setUp() throws Exception {
		// dado o método tal, retorne o tal coisa (para cada execução do método x, retorne y)
